<template>
  <b-menu-list>
    ...
    <!-- accounts -->
    <b-menu-item
      :expanded="activeGroup.accounts"
      :active="activeGroup.accounts"
      data-cy="accounts"
      @update:active="(state) => toggleGroup('accounts', state)"
    ...
    <!-- contacts -->
    <b-menu-item
      :expanded="activeGroup.contacts"
      :active="activeGroup.contacts"
      data-cy="contacts"
      @update:active="(state) => toggleGroup('contacts', state)"
      icon="account-multiple"
      label="Contacts"
    >
      <b-menu-item
    ...
    <!-- lists -->
    <b-menu-item
      :expanded="activeGroup.lists"
      :active="activeGroup.lists"
      data-cy="lists"
      @update:active="(state) => toggleGroup('lists', state)"
    ...
    <b-menu-item
      v-if="$can('subscribers:*')"
      :expanded="activeGroup.subscribers"
      :active="activeGroup.subscribers"
      data-cy="subscribers"
      @update:active="(state) => toggleGroup('subscribers', state)"
      icon="account-multiple"
    ...
    <b-menu-item
      v-if="$can('campaigns:*')"
      :expanded="activeGroup.campaigns"
      :active="activeGroup.campaigns"
      data-cy="campaigns"
      @update:active="(state) => toggleGroup('campaigns', state)"
    ...
    >
      ...
      <b-menu-item
        ...
        tag="router-link"
        :active="activeItem.campaignAnalytics"
        data-cy="analytics"
        icon="chart-bar"
    ...
    <b-menu-item
      ...
      :expanded="activeGroup.users"
      :active="activeGroup.users"
      data-cy="users"
      @update:active="(state) => toggleGroup('users', state)"
      icon="account-multiple"
    ...
    <b-menu-item
      ...
      data-cy="settings"
      @update:active="(state) => toggleGroup('settings', state)"
      icon="cog-outline"
